...
public class DoctorControllerTest {
    ...
    public void testList() throws Exception {
        ...
        MockHttpServletRequestBuilder mockHttpServletRequestBuilder = MockMvcRequestBuilders
            .post("/doctor/list.do").contentType(MediaType.APPLICATION_JSON_UTF8)
            .content("{'docName':'杨森','limit':15,'page':1}");
        //此请求并不需要添加请求参数
    ...
    public void testAdd() throws Exception {
        ...
        //请求方式为get
        MockHttpServletRequestBuilder mockHttpServletRequestBuilder = MockMvcRequestBuilders
            .post("/doctor/add.do").contentType(MediaType.APPLICATION_JSON_UTF8)
    ...
    public void testEdit() throws Exception {
        ...
        //请求方式为get
        MockHttpServletRequestBuilder mockHttpServletRequestBuilder = MockMvcRequestBuilders
            .post("/doctor/edit.do").contentType(MediaType.APPLICATION_JSON_UTF8)
