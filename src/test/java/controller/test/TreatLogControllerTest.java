...
public class TreatLogControllerTest {
    @Autowired
    ...
    public void testList() throws Exception {
        ...
        MockHttpServletRequestBuilder mockHttpServletRequestBuilder = MockMvcRequestBuilders
            .post("/treatLog/list.do").contentType(MediaType.APPLICATION_JSON_UTF8)
    ...
    public void testAdd() throws Exception {
        ...
        //请求方式为get
        MockHttpServletRequestBuilder mockHttpServletRequestBuilder = MockMvcRequestBuilders
            .post("/treatLog/add.do").contentType(MediaType.APPLICATION_JSON_UTF8)
            .content("{'patientNo':'1001','projectNo':'1001','treatBillNo':'20201213135060101','treatBillId':'1','treatCount':3,'zhiliaoNo':'102' ");
        //此请求并不需要添加请求参数
        mockMvc.perform(mockHttpServletRequestBuilder).andExpect(status().isOk())
            .andDo(print());
    }
